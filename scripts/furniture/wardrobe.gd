...
var item_data: Dictionary = { "id": "wardrobe", "name": "衣柜",
...
func replace_with_rotated_version(new_direction):
	var scene_path = "res://scenes/furnitures/wardrobe_%s.tscn" % new_direction
...
func get_surface_z_index():
	return $AnimatedSprite2D/ShelterBase.global_position.y
