...
var item_data: Dictionary = { "id": "desk", "name": "桌子", "price": 80, "icon": preload("res://art_resource/changjing/desk.png") }
...
func get_surface_z_index():
	return $Sprite2D/ShelterBase.global_position.y / 10 / scale.y
